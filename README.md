...
Each benchmark tab also has a **State of the art** table, and the controller conventions (step sizes, rotation format, frame, gripper sign) were checked against each project's default configs. Deep links: `#robocasa`, `#mikasa`, `#libero`, `#egogym`, `#robotwin`, `#rlbench`, `#vlabench`, `#liberoplus`, `#metaworld`.
